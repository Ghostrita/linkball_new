            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ">Type User</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <h6 class="text-xs font-weight-bold mb-0">John naja</h6>
                          <!--p class="text-xs text-secondary mb-0">Organization</!--p-->
                    </td>

                  <td>
                    <h6 class="text-xs font-weight-bold mb-0 text-center">Admin</h6>
                          <!--p class="text-xs text-secondary mb-0">Organization</!--p-->
                  </td>
                        
                  <td class="align-middle text-center text-sm">
                    <h6 class="text-xs font-weight-bold mb-0">9999</h6>
                          <!--span class="badge badge-sm bg-gradient-success">Online</span-->
                  </td>
                  <td class="align-middle text-center">
                    <h6 class="text-xs font-weight-bold mb-0">T/F</h6>
                ...
                <tr>
                  ...
                  <td class="w-20">       <!--width 20%-->
                    <div class="d-flex px-2 py-1">
                      <div>
                        <img src="assets/img/user2.png" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">Jane Michael</h6>
                              <!--p class="text-xs text-secondary mb-0">john@creative-tim.com</!--p-->
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <h6 class="text-xs font-weight-bold mb-0">Jane naka</h6>
                            <!--p class="text-xs text-secondary mb-0">Organization</!--p-->
                  </td>
                ...
                <tr>
                  <td class="w-20">       <!--width 20%-->
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">Jone Michael</h6>
                              <!--p class="text-xs text-secondary mb-0">john@creative-tim.com</!--p-->
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <h6 class="text-xs font-weight-bold mb-0">Jone naja</h6>
                          <!--p class="text-xs text-secondary mb-0">Organization</!--p-->
                  </td>
                ...
                <tr>
                  <td class="w-20">       <!--width 20%-->
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">John Michy</h6>
                              <!--p class="text-xs text-secondary mb-0">john@creative-tim.com</!--p-->
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <h6 class="text-xs font-weight-bold mb-0 text-center">User</h6>
                          <!--p class="text-xs text-secondary mb-0">Organization</!--p-->
                  </td>
                ...
                <tr>
                  <td class="w-20">       <!--width 20%-->
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">Jane Michy</h6>
                              <!--p class="text-xs text-secondary mb-0">john@creative-tim.com</!--p-->
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  <td class="w-20">       <!--width 20%-->
                    <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Jone Michy</h6>
                              <!--p class="text-xs text-secondary mb-0">john@creative-tim.com</!--p-->
                            </div>
                          </div>
                        </td>
